...
```html
<script src="https://cdn.jsdelivr.net/npm/stelace@0.6.0/stelace.browser.min.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/stelace@0.6.0/dist/stelace.evergreen.min.js"></script>
```
