...
```html
<script src="https://cdn.jsdelivr.net/npm/stelace@0.5.1/stelace.browser.min.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/stelace@0.5.1/dist/stelace.evergreen.min.js"></script>
```
